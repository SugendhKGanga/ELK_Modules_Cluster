...
#	        Class['redis::dependancies'] ~> Class['redis::setup']  ~> Class['redis::start_services']
                Class['redis::setup']  ~> Class['redis::start_services']
...
#			Class['redis::dependancies'] ~> Class['redis::setup'] ~> Class['redis::configure_slave'] ~> Class['redis::start_services'] 
                       Class['redis::setup'] ~> Class['redis::configure_slave'] ~> Class['redis::start_services']
...
class redis::setup {
	...
	$redis_group = $redis::params::redis_group
	$make_redis_deb = $redis::params::make_redis_deb
	$redis_home = $redis::params::redis_home
...
class redis::start_services {
 ...
 exec { "run redis":
               command => "${redis_home}/src/redis-server /opt/redis_dir/redis-3.2.8/redis.conf &",
             }->

 exec { "run sentinel":
               command => "${redis_home}/src/redis-server /opt/redis_dir/redis-3.2.8/sentinel.conf --sentinel &",
             }
}
